...
source $HOME/.config/priba_setup/nvim/config/plugins.vim
source $HOME/.config/priba_setup/nvim/config/utils.vim
...
"insert breakpoints
map <C-b> Oimport pdb; pdb.set_trace()  # BREAKPOINT<C-c>
